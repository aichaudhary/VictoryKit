      ...
      <div className="flex-grow overflow-y-auto custom-scrollbar space-y-8 text-xs font-mono pr-1">
        ...
        <div className="p-4 bg-cyan-950/10 border border-cyan-500/20 rounded-lg space-y-3">
          <div className="flex items-center gap-2 mb-1">
            ...
            <h3 className="text-cyan-500 font-bold uppercase tracking-widest text-[9px]">
              Engine State
            </h3>
          </div>
          <div className="grid grid-cols-2 gap-y-2 text-[9px]">
            <span className="text-gray-600 uppercase">Co-Processor:</span>{" "}
            <span className="text-gray-300">ACTIVE</span>
            <span className="text-gray-600 uppercase">Context:</span>{" "}
            <span className="text-gray-300">
              {(settings.maxTokens / 1024).toFixed(1)}k PKTS
            </span>
            <span className="text-gray-600 uppercase">Precision:</span>{" "}
            <span className="text-gray-300">FP16</span>
          </div>
        </div>
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <h3 className="text-green-500 font-bold uppercase text-[9px] tracking-widest">
              Directive Alpha
            </h3>
        ...
        {/* Neural Presets */}
        <div className="space-y-3">
          <h3 className="text-yellow-500 font-bold uppercase text-[9px] tracking-widest">
            Core Presets
          </h3>
        ...
        <div className="space-y-4 pt-4 border-t border-gray-900">
          <div className="flex flex-col space-y-2">
            <label className="text-gray-700 uppercase text-[9px] tracking-widest">
              Protocol ID
            </label>
            <input
              type="text"
              ...
              onChange={(e) =>
                onChange({ ...settings, agentName: e.target.value })
              }
