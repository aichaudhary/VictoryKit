      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-40">
          <div ref={heroTextRef} className="space-y-10">
            ...
            <h1 className="text-8xl md:text-9xl font-black tracking-tighter leading-[0.85]">
              ZERODAY <span className="text-red-500">DETECT</span>
            </h1>
            <p className="text-xl md:text-2xl text-white/60 font-medium leading-relaxed max-w-xl">
              360° threat visibility. Comprehensive zero-day threat detection system that identifies
              unknown vulnerabilities and exploits before they cause damage.
            </p>
          ...
          <div className="relative group aspect-square rounded-[4rem] overflow-hidden border border-white/10 shadow-2xl">
            <img
              src="https://picsum.photos/seed/zerodaydetect/1200/1200"
              alt="ZeroDayDetect AI Visualized"
        ...
        <div ref={contentRef} className="space-y-40 mb-40">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-24 border-y border-white/10 text-center">
            <div>
              <div className="text-5xl font-black text-red-500 tracking-tighter">99.7%</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                Detection Rate
              </div>
            </div>
            <div>
              <div className="text-5xl font-black text-white tracking-tighter">&lt;1min</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                Mean Time to Detect
              </div>
            </div>
            <div>
              <div className="text-5xl font-black text-white tracking-tighter">&lt;0.1%</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                False Positives
              </div>
            </div>
            <div>
              <div className="text-5xl font-black text-white tracking-tighter">AI-Core</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                Behavioral Engine
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-red-500/20 transition-all group">
              ...
              <p className="text-white/50 leading-relaxed font-medium">
                Detect unknown threats through behavioral patterns without relying on signatures.
              </p>
            </div>
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-red-500/20 transition-all group">
              <div className="w-16 h-16 rounded-2xl bg-red-500/10 flex items-center justify-center text-red-500 group-hover:scale-110 transition-transform">
              ...
              <p className="text-white/50 leading-relaxed font-medium">
                Block exploitation attempts in real-time before vulnerabilities are publicly
                disclosed.
              </p>
            </div>
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-red-500/20 transition-all group">
              ...
              <p className="text-white/50 leading-relaxed font-medium">
                Proactive hunting for advanced persistent threats hiding in your infrastructure.
              </p>
            </div>
          </div>
        </div>
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center py-40 border-t border-white/10">
          ...
          >
            Activate Detection <Zap className="w-5 h-5 fill-current" />
          </a>
        </div>
      </div>
    </div>
