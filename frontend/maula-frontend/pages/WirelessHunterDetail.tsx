...
import { ArrowLeft, Zap, Shield, Signal, Network, Search, ShieldAlert, Wifi } from 'lucide-react';

const WirelessHunterDetail: React.FC = () => {
    ...
    <div ref={containerRef} className="min-h-screen bg-[#030d06] text-white selection:bg-emerald-500/30 font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-12">
        <div className="flex items-center justify-between mb-24">
          ...
          <span className="text-[10px] font-black tracking-[0.4em] uppercase text-white/40">WirelessHunter v3.8</span>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-40">
           <div ref={heroTextRef} className="space-y-10">
              <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full glass border border-emerald-500/20 backdrop-blur-3xl">
                ...
                <span className="text-[10px] font-black tracking-[0.4em] uppercase text-emerald-500">Rogue Device Detection</span>
              </div>
              <h1 className="text-8xl md:text-9xl font-black tracking-tighter leading-[0.85] uppercase">
                WIRELESS <span className="text-emerald-500">HUNTER</span>
              </h1>
           ...
           <div className="relative group aspect-square rounded-[4rem] overflow-hidden border border-white/10 shadow-2xl">
              <img src="https://picsum.photos/seed/wirelesshunter/1200/1200" className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-1000 scale-105 group-hover:scale-100" alt="Tool Visual" />
        ...
        <div ref={contentRef} className="space-y-40 mb-40">
           <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-24 border-y border-white/10 text-center">
              <div><div className="text-5xl font-black text-emerald-500">RF</div><div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">Fingerprinting</div></div>
              <div><div className="text-5xl font-black text-white">Evil</div><div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">Twin Detection</div></div>
              <div><div className="text-5xl font-black text-white">Spectrum</div><div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">Analysis</div></div>
              <div><div className="text-5xl font-black text-white">Auto</div><div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">Containment</div></div>
           </div>
           <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-emerald-500/20 transition-all group">
                 ...
                 <h3 className="text-3xl font-bold">Evil Twin Block</h3>
                 <p className="text-white/50 leading-relaxed">Detect and block evil twin access points that mimic legitimate networks to steal credentials.</p>
              </div>
              <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-emerald-500/20 transition-all group">
                 <div className="w-16 h-16 rounded-2xl bg-emerald-500/10 flex items-center justify-center text-emerald-500"><Signal className="w-8 h-8" /></div>
                 <h3 className="text-3xl font-bold">RF Fingerprinting</h3>
                 <p className="text-white/50 leading-relaxed">Identify devices by unique RF signatures to detect spoofed MAC addresses and hidden rogues.</p>
              </div>
              <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-emerald-500/20 transition-all group">
                 ...
                 <h3 className="text-3xl font-bold">Physical Location</h3>
                 <p className="text-white/50 leading-relaxed">Triangulate rogue device locations with meter-level accuracy for physical security response.</p>
              </div>
           </div>
        </div>
