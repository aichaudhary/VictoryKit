...
const incidentcommandDetail: React.FC = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-[#0d0408] text-white selection:bg-red-500/30 font-sans"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-40">
          <div ref={heroTextRef} className="space-y-10">
            ...
            <p className="text-xl md:text-2xl text-white/60 font-medium leading-relaxed max-w-xl">
              Incident response platform. Streamlined security incident management with automated
              playbooks and coordinated team response workflows.
            </p>
        ...
        <div ref={contentRef} className="space-y-40 mb-40">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-24 border-y border-white/10 text-center">
            ...
            <div>
              <div className="text-5xl font-black text-white">&lt;15m</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                Mean Response
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-red-500/20 transition-all group">
              ...
              <p className="text-white/50 leading-relaxed">
                AI-powered incident classification and prioritization to focus resources on critical
                threats first.
              </p>
            </div>
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-red-500/20 transition-all group">
              ...
              <p className="text-white/50 leading-relaxed">
                Real-time collaboration tools for security teams with role-based task assignment and
                escalation.
              </p>
            </div>
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-red-500/20 transition-all group">
              ...
              <p className="text-white/50 leading-relaxed">
                Automated timeline reconstruction and evidence collection for thorough post-incident
                analysis.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center py-40 border-t border-white/10">
          ...
          >
            Manage Incidents <Zap className="w-5 h-5 fill-current" />
          </a>
        </div>
      </div>
    </div>
