    ...
    <div ref={containerRef} className="min-h-screen bg-[#030d06] text-white selection:bg-emerald-500/30 font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center py-40 border-t border-white/10">
           ...
           <a href="https://iotsentinel.maula.ai" target="_blank" rel="noopener noreferrer" className="px-16 py-8 bg-emerald-500 text-black rounded-[2.5rem] font-black text-sm tracking-[0.4em] uppercase hover:brightness-110 shadow-2xl flex items-center gap-4 text-center">Secure Devices <Zap className="w-5 h-5 fill-current" /></a>
        </div>
      </div>
    </div>
  );
