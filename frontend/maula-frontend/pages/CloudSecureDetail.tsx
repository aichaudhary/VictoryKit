...
const CloudSecureDetail: React.FC = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-[#040d0a] text-white selection:bg-emerald-500/30 font-sans"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-40">
          <div ref={heroTextRef} className="space-y-10">
            ...
            <p className="text-xl md:text-2xl text-white/60 font-medium leading-relaxed max-w-xl">
              Network forensics tools. Deep packet capture and analysis for incident investigation,
              threat hunting, and network security monitoring.
            </p>
          ...
          <div className="relative group aspect-square rounded-[4rem] overflow-hidden border border-white/10 shadow-2xl">
            <img
              src="https://picsum.photos/seed/networkforensics/1200/1200"
              className="w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-1000 scale-105 group-hover:scale-100"
              alt="NetworkForensics Visual"
            />
        ...
        <div ref={contentRef} className="space-y-40 mb-40">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-24 border-y border-white/10 text-center">
            <div>
              <div className="text-5xl font-black text-emerald-500">100Gbps</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                Capture Speed
              </div>
            </div>
            <div>
              <div className="text-5xl font-black text-white">PETABYTE</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                Storage Capacity
              </div>
            </div>
            <div>
              <div className="text-5xl font-black text-white">L7</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                Deep Inspection
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-emerald-500/20 transition-all group">
              ...
              <p className="text-white/50 leading-relaxed">
                Complete network traffic recording with indexed storage for rapid historical
            ...
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-emerald-500/20 transition-all group">
              ...
              <p className="text-white/50 leading-relaxed">
                Support for 3000+ protocols with automatic decoding and session reconstruction for
                analysis.
              </p>
            </div>
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-emerald-500/20 transition-all group">
              ...
              <p className="text-white/50 leading-relaxed">
                Visual timeline reconstruction of network events with correlation to security alerts
                and incidents.
              </p>
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center py-40 border-t border-white/10">
          ...
          >
            Analyze Traffic <Zap className="w-5 h-5 fill-current" />
          </a>
        </div>
      </div>
    </div>
