          ...
          <g key={chainIdx} opacity={chainIdx === activeChain ? 1 : 0.2}>
            {chain.nodes.map((node, i) => (
              <g key={i}>
                {i > 0 && (
                  <line
                    x1={chain.nodes[i - 1][0]}
                    y1={chain.nodes[i - 1][1]}
                    x2={node[0]}
                    y2={node[1]}
...
const DetectionTimeline: React.FC = () => {
  const [events, setEvents] = useState<
    { id: number; type: string; time: string; severity: string }[]
  >([]);
    ...
    <div className="absolute top-4 right-4 opacity-40">
      <div className="space-y-1">
        {signals.map((signal) => (
          <div
            key={signal.source}
            className="flex items-center gap-2 text-[8px] font-mono text-purple-400"
          >
...
const ThreatHeatmap: React.FC = () => {
  const [hotspots, setHotspots] = useState<
    { id: number; x: number; y: number; intensity: number }[]
  >([]);
...
<style>{`@keyframes spin-radar { from { transform: rotate(0deg); } to { transform: rotate(360deg); } }`}</style>
        ...
        {hotspots.map((spot) => (
          ...
          >
            <animate
              attributeName="r"
              values={`${8 * spot.intensity};${12 * spot.intensity};${8 * spot.intensity}`}
              dur="3s"
              repeatCount="indefinite"
            />
          </circle>
...
const XDRPlatformDetail: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'overview' | 'detection' | 'response' | 'analytics'>(
    'overview'
  );
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="relative mb-8 sm:mb-12 md:mb-16 rounded-[3rem] overflow-hidden border border-purple-500/20 bg-gradient-to-br from-purple-900/20 via-violet-900/10 to-transparent p-12">
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center gap-12">
            ...
            <div className="relative w-48 h-48 flex-shrink-0">
              <div
                className="absolute inset-0 rounded-full bg-gradient-to-br from-purple-600 to-violet-700 animate-pulse"
              ...
              {[0, 1, 2, 3].map((i) => (
                ...
                >
                  <div
                    className="w-full h-full rounded-full bg-purple-400 animate-ping"
            ...
            <div className="flex-1 text-center lg:text-left">
              ...
              <p className="text-lg text-white/60 max-w-xl mb-8">
                Unified security platform correlating data across endpoints, networks, cloud, and
                applications for comprehensive threat visibility.
              </p>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-purple-500/10 rounded-2xl p-4 border border-purple-500/20">
                  <div className="text-2xl font-black text-purple-400">
                    {liveMetrics.eventsPerSec.toLocaleString()}
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-purple-900/20 to-transparent p-8 group hover:border-purple-500/30 transition-all">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-white/50 leading-relaxed">
                      Correlate threats across endpoint, network, cloud, and email for complete
                      attack chain visibility and automated investigation.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-purple-900/20 to-transparent p-8 group hover:border-purple-500/30 transition-all">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-white/50 leading-relaxed">
                      Single pane of glass for all security operations with automated investigation
                      and response workflows powered by AI.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-gradient-to-br from-purple-900/20 to-transparent p-8 group hover:border-purple-500/30 transition-all">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-white/50 leading-relaxed">
                      Integrated threat intelligence feeds enriching alerts with context for faster
                      triage and prioritized response actions.
                    </p>
                  </div>
                </div>
              </div>
                    ...
                    {[
                      {
                        ...
                        value: '15,000+',
                        desc: 'Pre-built detection rules',
                      },
                    ...
                    {[
                      {
                        ...
                        desc: 'Automatically quarantine compromised systems',
                        icon: Lock,
                      },
                      {
                        title: 'Block Threat',
                        desc: 'Real-time blocking of malicious IPs/domains',
                        icon: Shield,
                      },
                      {
                        title: 'Kill Process',
                        desc: 'Terminate malicious processes remotely',
                        icon: Target,
                      },
                      {
                        title: 'Collect Evidence',
                        desc: 'Automated forensic data collection',
                        icon: FileSearch,
                      },
                    ].map((action, i) => (
                      <div
                        key={i}
                        className="flex items-start gap-4 bg-white/5 rounded-xl p-6 border border-white/10 hover:border-purple-500/30 transition-all"
                      >
                    ...
                    {[
                      {
                        ...
                        desc: 'Board-ready security metrics and KPIs',
                        icon: BarChart3,
                      },
                      {
                        title: 'Trend Analysis',
                        desc: 'Historical threat pattern analysis',
                        icon: TrendingUp,
                      },
                      {
                      ...
                      <div
                        key={i}
                        className="bg-white/5 rounded-xl p-6 border border-white/10 hover:border-purple-500/30 transition-all text-center"
                      >
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center py-20">
          ...
          <a
            href="https://xdrplatform.maula.ai"
            target="_blank"
            rel="noopener noreferrer"
            className="px-12 py-6 bg-gradient-to-r from-purple-600 to-violet-600 text-white rounded-[2rem] font-black text-sm tracking-[0.4em] uppercase hover:brightness-110 shadow-2xl shadow-purple-500/30 flex items-center gap-4 text-center"
          >
