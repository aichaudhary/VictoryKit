    ...
    <div ref={containerRef} className="min-h-screen bg-[#030408] text-white selection:bg-blue-500/30 font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-40">
           <div ref={heroTextRef} className="space-y-10">
              ...
              <div className="flex gap-6 pt-4">
                 <div className="px-8 py-4 bg-blue-500 text-white rounded-2xl font-black text-xs tracking-[0.3em] uppercase hover:brightness-125 transition-all shadow-2xl shadow-blue-500/20">Test Failover</div>
        ...
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center py-40 border-t border-white/10">
           ...
           <a href="https://drplan.maula.ai" target="_blank" rel="noopener noreferrer" className="px-16 py-8 bg-blue-500 text-white rounded-[2.5rem] font-black text-sm tracking-[0.4em] uppercase hover:brightness-110 shadow-2xl flex items-center gap-4 text-center">Launch DR Test <Zap className="w-5 h-5 fill-current" /></a>
        </div>
      </div>
    </div>
  );
