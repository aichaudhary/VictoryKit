...
const BrowserIsolationDetail: React.FC = () => {
  ...
  return (
    <div
      ref={containerRef}
      className="min-h-screen bg-[#030d06] text-white selection:bg-emerald-500/30 font-sans"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-40">
          <div ref={heroTextRef} className="space-y-10">
            ...
            <p className="text-xl md:text-2xl text-white/60 font-medium leading-relaxed max-w-xl">
              Remote browser isolation for safe web access, rendering risky content in cloud
              containers while streaming safe pixels to users.
            </p>
            <div className="flex gap-6 pt-4">
              <a
                href="https://browserisolation.maula.ai"
                target="_blank"
          ...
          <div className="relative group aspect-square rounded-[4rem] overflow-hidden border border-white/10 shadow-2xl">
            <img
              src="https://picsum.photos/seed/browserisolation/1200/1200"
        ...
        <div ref={contentRef} className="space-y-40 mb-40">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-24 border-y border-white/10 text-center">
            <div>
              <div className="text-5xl font-black text-emerald-500">100%</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                Isolation
              </div>
            </div>
            <div>
              <div className="text-5xl font-black text-white">Cloud</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                Rendering
              </div>
            </div>
            <div>
              <div className="text-5xl font-black text-white">&lt;50ms</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                Latency
              </div>
            </div>
            <div>
              <div className="text-5xl font-black text-white">Pixel</div>
              <div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">
                Streaming
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-emerald-500/20 transition-all group">
              ...
              <p className="text-white/50 leading-relaxed">
                Execute web content in disposable cloud containers that are destroyed after each
                session.
              </p>
            </div>
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-emerald-500/20 transition-all group">
              ...
              <p className="text-white/50 leading-relaxed">
                No web content touches user devices—only safe visual streams reach endpoints.
              </p>
            </div>
            <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-emerald-500/20 transition-all group">
              <div className="w-16 h-16 rounded-2xl bg-emerald-500/10 flex items-center justify-center text-emerald-500">
              ...
              <p className="text-white/50 leading-relaxed">
                Prevent downloads, clipboard access, and file uploads with granular DLP policies.
              </p>
            </div>
          </div>
        </div>
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center py-40 border-t border-white/10">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="px-16 py-8 bg-emerald-500 text-black rounded-[2.5rem] font-black text-sm tracking-[0.4em] uppercase hover:brightness-110 shadow-2xl flex items-center gap-4 text-center"
          >
            Start Isolation <Zap className="w-5 h-5 fill-current" />
          </a>
        </div>
      </div>
    </div>
