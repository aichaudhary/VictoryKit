...
export const tools: SecurityTool[] = [
  ...
  },
  {
    id: 2,
    name: "DarkWebMonitor",
    description: "Intelligence that sees everything. Advanced threat intelligence platform that monitors dark web markets, forums, and encrypted channels for stolen credentials and data.",
  ...
  },
  {
    id: 3,
    name: "ZeroDayDetect",
    description: "360° threat visibility. Comprehensive zero-day threat detection system that identifies unknown vulnerabilities and exploits before they cause damage.",
    category: "Threat Detection",
  ...
  },
  {
    id: 4,
    name: "RansomShield",
    description: "Complete ransomware protection. Advanced ransomware detection and prevention using behavioral analysis, file integrity monitoring, and instant recovery.",
    category: "Malware",
  ...
  },
  {
    id: 5,
    name: "PhishNetAI",
    description: "Catch every phish in the net. AI-powered phishing detection that analyzes URLs, emails, and web content with machine learning precision.",
    category: "Phishing",
  ...
  },
  {
    id: 8,
    name: "CodeSentinel",
    description: "Code security from the start. Static and dynamic application security testing integrated into your CI/CD pipeline with intelligent code analysis.",
  ...
  },
  {
    id: 9,
    name: "RuntimeGuard",
    description: "Runtime application protection. Real-time application security monitoring and protection that detects and blocks attacks during execution.",
  ...
  },
  {
    ...
    description: "Respond faster, recover stronger. Comprehensive incident response platform with automated playbooks, team collaboration, and forensic capabilities.",
  ...
  },
  {
    id: 12,
    name: "XDRPlatform",
    description: "Extended detection and response. Unified XDR platform that correlates data across endpoints, networks, cloud, and applications for comprehensive threat visibility.",
  ...
  },
  {
    id: 14,
    name: "SecretVault",
    description: "Secrets management done right. Enterprise secrets and credentials management with automated rotation and secure storage.",
  ...
  },
  {
    id: 15,
    name: "PrivilegeGuard",
    description: "Protect privileged access. Privileged access management with just-in-time access, session recording, and credential vaulting.",
  ...
  },
  {
    ...
    description: "Network visibility and forensics. Deep network traffic analysis and forensics for threat hunting and incident investigation.",
    category: "Network",
  ...
  },
  {
    id: 17,
    name: "AuditTrailPro",
    description: "Audit with confidence. Comprehensive audit trail management with automated evidence collection, compliance reporting, and change tracking.",
    category: "Audit",
  ...
  },
  {
    id: 18,
    name: "ThreatModel",
    description: "Proactive threat modeling. Automated threat modeling platform that identifies potential attack vectors and security gaps in your architecture.",
  ...
  },
  {
    id: 19,
    name: "RiskQuantify",
    description: "Quantify your risk. AI-powered risk assessment and scoring to continuously evaluate and prioritize your security posture.",
    category: "Risk",
  ...
  },
  {
    ...
    description: "Unified security visibility. Centralized security dashboard with real-time metrics, KPIs, and executive reporting across your entire security stack.",
    category: "Monitoring",
  ...
  },
  {
    id: 21,
    name: "WAFManager",
    description: "Web application firewall management. Centralized WAF management with custom rules, bot protection, and real-time threat intelligence.",
  ...
  },
  {
    id: 22,
    name: "APIShield",
    description: "Secure every API call. API security testing and runtime protection against API-specific attacks, abuse, and shadow APIs.",
    category: "API",
    stats: { threatsBlocked: "Unlimited", uptime: "50+ Atk Typ", accuracy: "<5ms Lat" },
  ...
  },
  {
    id: 23,
    name: "BotMitigation",
    description: "Stop malicious bots. Advanced bot detection and mitigation that distinguishes between good bots, bad bots, and human traffic.",
  ...
  },
  {
    id: 24,
    name: "DDoSDefender",
    description: "DDoS protection at scale. Multi-layer DDoS protection with automatic mitigation, traffic scrubbing, and real-time attack analytics.",
    category: "DDoS",
  ...
  },
  {
    id: 25,
    name: "SSLMonitor",
    description: "Certificate management simplified. SSL/TLS certificate monitoring with expiration alerts, vulnerability detection, and automated renewal.",
  ...
  },
  {
    id: 26,
    name: "BlueTeamAI",
    description: "Defend with intelligence. AI-powered blue team operations center for automated defense, threat hunting, and incident triage.",
    category: "Blue Team",
  ...
  },
  {
    ...
    description: "Behavior tells the story. User and entity behavior analytics powered by machine learning to detect insider threats and anomalies.",
    category: "Behavior",
    stats: { threatsBlocked: "Unlimited", uptime: "20+ Models", accuracy: "<1hr Det" },
  ...
  },
  {
    id: 31,
    name: "CloudPosture",
    description: "Secure your cloud journey. Cloud security posture management for AWS, Azure, and GCP with continuous monitoring and auto-remediation.",
    category: "Cloud",
    stats: { threatsBlocked: "Multi-Cloud", uptime: "1000+ Checks", accuracy: "Auto Remed" },
  ...
  },
  {
    id: 32,
    name: "ZeroTrust",
    description: "Trust nothing, verify everything. Zero trust architecture implementation with continuous verification and least privilege access.",
    category: "Zero Trust",
  ...
  },
  {
    id: 33,
    name: "KubeArmor",
    description: "Kubernetes security hardening. Runtime security for Kubernetes with policy enforcement, network segmentation, and workload protection.",
    category: "Container",
  ...
  },
  {
    id: 34,
    name: "ContainerScan",
    description: "Container security done right. Container image scanning and runtime protection from build to production with vulnerability detection.",
    category: "Container",
    stats: { threatsBlocked: "All Major", uptime: "200K+ CVEs", accuracy: "<30s Scan" },
  ...
  },
  {
    id: 35,
    name: "EmailDefender",
    description: "Secure every inbox. Advanced email security with threat detection, anti-phishing, DLP, and encryption for complete email protection.",
    category: "Email",
  ...
  },
  {
    ...
    description: "Safe browsing guaranteed. Remote browser isolation that protects users from web-based threats by executing content in secure containers.",
    category: "Web",
  ...
  },
  {
    id: 37,
    name: "DNSFirewall",
    description: "DNS security layer. DNS-layer security firewall that blocks threats before they reach your network with threat intelligence.",
    category: "DNS",
  ...
  },
  {
    id: 38,
    name: "FirewallAI",
    description: "Intelligent perimeter defense. AI-powered next-generation firewall with advanced threat prevention and adaptive policies.",
    category: "Firewall",
  ...
  },
  {
    id: 39,
    name: "VPNAnalyzer",
    description: "Secure remote access. Enterprise VPN with zero-trust network access, traffic analysis, and granular access controls.",
    category: "VPN",
  ...
  },
  {
    id: 40,
    name: "WirelessHunter",
    description: "Secure your airwaves. Wireless intrusion detection and prevention with rogue AP detection and spectrum analysis.",
    category: "Wireless",
  ...
  },
  {
    id: 41,
    name: "DLPAdvanced",
    description: "Advanced data loss prevention. Enterprise DLP with intelligent content inspection, policy enforcement, and cross-channel protection.",
    category: "Data Protection",
    stats: { threatsBlocked: "100+ Types", uptime: "Custom Sens", accuracy: "AES-256" },
  ...
  },
  {
    id: 42,
    name: "IoTSentinel",
    description: "Secure the connected world. IoT security platform for device discovery, monitoring, vulnerability management, and protection.",
    category: "IoT",
  ...
  },
  {
    id: 43,
    name: "MobileShield",
    description: "Mobile security everywhere. Mobile threat defense for iOS and Android against phishing, malware, and network attacks.",
    category: "Mobile",
  ...
  },
  {
    id: 44,
    name: "SupplyChainAI",
    description: "Secure your supply chain. AI-powered software supply chain security with dependency analysis, SBOM generation, and vulnerability tracking.",
  ...
  },
  {
    id: 45,
    name: "DRPlan",
    description: "Disaster recovery made simple. Comprehensive disaster recovery planning, testing, and orchestration for business continuity.",
    category: "DR",
  ...
  },
  {
    id: 46,
    name: "PrivacyShield",
    description: "Privacy by design. Privacy management platform for data subject requests, consent management, and privacy impact assessments.",
    category: "Privacy",
  ...
  },
  {
    id: 47,
    name: "GDPRCompliance",
    description: "GDPR made manageable. Complete GDPR compliance management with data mapping, DPIA automation, and breach notification.",
    category: "GDPR",
  ...
  },
  {
    id: 48,
    name: "HIPAAGuard",
    description: "Healthcare compliance simplified. HIPAA compliance management with PHI protection, access monitoring, and audit trails.",
    category: "HIPAA",
  ...
  },
  {
    id: 49,
    name: "SOC2Automator",
    description: "SOC 2 compliance automated. Continuous SOC 2 compliance monitoring with evidence collection, gap analysis, and audit preparation.",
    category: "Compliance",
  ...
  },
  {
    id: 50,
    name: "ISO27001",
    description: "ISO 27001 certification ready. Complete ISO 27001 compliance management with controls mapping, risk assessment, and certification support.",
    category: "Compliance",
