...
import { ArrowLeft, Radar, Zap, Activity, Layers, Signal, ShieldAlert, Cpu, Crosshair } from 'lucide-react';
    ...
    <div ref={containerRef} className="min-h-screen bg-[#0d0404] text-white selection:bg-red-500/30 font-sans">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 py-12">
        <div className="flex items-center justify-between mb-24">
          ...
          <span className="text-[10px] font-black tracking-[0.4em] uppercase text-white/40">ThreatRadar Core v12.4</span>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 items-center mb-40">
           <div ref={heroTextRef} className="space-y-10">
              <div className="inline-flex items-center gap-3 px-5 py-2 rounded-full glass border border-red-500/20 backdrop-blur-3xl">
                ...
                <span className="text-[10px] font-black tracking-[0.4em] uppercase text-red-500">Infrastructure Visibility</span>
              </div>
              <h1 className="text-8xl md:text-9xl font-black tracking-tighter leading-[0.85]">THREAT <span className="text-red-500">RADAR</span></h1>
              <p className="text-xl md:text-2xl text-white/60 font-medium leading-relaxed max-w-xl">
                The ultimate watchtower. Correlate millions of signals across cloud, network, and endpoints into a single unified threat narrative.
              </p>
              <div className="flex gap-6 pt-4">
                 <div className="px-8 py-4 bg-red-500 text-white rounded-2xl font-black text-xs tracking-[0.3em] uppercase hover:brightness-125 transition-all shadow-2xl shadow-red-500/20">Visibility: 360°</div>
                 <div className="px-8 py-4 bg-white/5 border border-white/10 text-white rounded-2xl font-black text-xs tracking-[0.3em] uppercase hover:bg-white/10 transition-all">MTTD: &lt;60s</div>
              </div>
           </div>
           <div className="relative group aspect-square rounded-[4rem] overflow-hidden border border-white/10 shadow-2xl">
              <img src="https://picsum.photos/seed/tradar_deep/1200/1200" alt="ThreatRadar AI Visualized" className="w-full h-full object-cover grayscale group-hover:grayscale-0 transition-all duration-1000" />
        ...
        <div ref={contentRef} className="space-y-40 mb-40">
           <div className="grid grid-cols-1 md:grid-cols-4 gap-12 py-24 border-y border-white/10 text-center">
              ...
              <div><div className="text-5xl font-black text-white tracking-tighter">360°</div><div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">Signal Coverage</div></div>
              ...
              <div><div className="text-5xl font-black text-white tracking-tighter">AI-Sync</div><div className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30 mt-2">Correlation Engine</div></div>
           </div>
           <div className="grid grid-cols-1 md:grid-cols-3 gap-16">
              <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-red-500/20 transition-all group">
                 ...
                 <h3 className="text-3xl font-bold tracking-tight">Signal Fusion</h3>
                 <p className="text-white/50 leading-relaxed font-medium">Automatically merges signals from SIEM, EDR, and NDR into high-fidelity incidents.</p>
              </div>
              <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-red-500/20 transition-all group">
                 ...
                 <h3 className="text-3xl font-bold tracking-tight">Infrastructure Graphs</h3>
                 <p className="text-white/50 leading-relaxed font-medium">Visualizes the entire attack path in real-time across your cloud assets.</p>
              </div>
              <div className="space-y-8 glass p-10 rounded-[3rem] border border-white/5 hover:border-red-500/20 transition-all group">
                 ...
                 <h3 className="text-3xl font-bold tracking-tight">Precision Triage</h3>
                 <p className="text-white/50 leading-relaxed font-medium">Prioritizes threats based on business impact, ensuring team focus on critical risks.</p>
              </div>
           </div>
        </div>
        <div className="flex flex-col md:flex-row gap-8 items-center justify-center py-40 border-t border-white/10">
           ...
           <button className="px-16 py-8 bg-red-500 text-white rounded-[2.5rem] font-black text-sm tracking-[0.4em] uppercase hover:brightness-110 shadow-2xl flex items-center gap-4 text-center">Launch Tool <Zap className="w-5 h-5 fill-current" /></button>
        </div>
      </div>
    </div>
  );
