    ...
    <div className="min-h-screen w-full flex items-center justify-center p-6 bg-[#02000a] relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="text-3xl font-black text-white uppercase tracking-tighter cursor-pointer" onClick={() => setView('landing')}>Maula<span className="text-purple-500">.ai</span></h1>
        </div>
