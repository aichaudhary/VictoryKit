  ...
  connect(): Promise<void> {
    ...
    return new Promise((resolve, reject) => {
      try {
        ...
        this.ws.onopen = () => {
          console.log('Connected to KubeArmor AI');
        ...
        this.ws.onclose = () => {
          console.log('Disconnected from KubeArmor AI');
          this.isConnecting = false;
        ...
        this.ws.onerror = (error) => {
          console.error('KubeArmor AI WebSocket error:', error);
          this.isConnecting = false;
          reject(error);
        };
      } catch (error) {
...
// Singleton instance
let aiServiceInstance: KubeArmorAIService | null = null;

export function getAIService(): KubeArmorAIService {
  if (!aiServiceInstance) {
    aiServiceInstance = new KubeArmorAIService();
  }
  return aiServiceInstance;
}

export default KubeArmorAIService;
