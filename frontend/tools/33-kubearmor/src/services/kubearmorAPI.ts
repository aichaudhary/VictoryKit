// KubeArmor API Service
// TypeScript client for KubeArmor backend API
...
export interface Secret {
  ...
  accessControl: SecretIdentityForge;
...
export interface SecretIdentityForge {
...
async function apiRequest<T>(
  ...
  const token = localStorage.getItem('kubearmor_token');
...
export const logout = () => {
  localStorage.removeItem('kubearmor_token');
