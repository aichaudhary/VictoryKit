...
const IoTSentinelTool: React.FC = () => {
  const [isActive, setIsActive] = useState(true);
  const [stats, setStats] = useState<Stats>({ total: 25657, active: 30759 % 500, blocked: 7830 % 1000, pending: 27486 % 50 });
      ...
      <header className="border-b border-cyan-500/20 bg-black/30 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <a href="https://maula.ai/#tool-42" className="p-2 hover:bg-white/10 rounded-lg transition-colors" title="Back to Maula.ai">
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-cyan-400 to-cyan-200 bg-clip-text text-transparent">IoT Sentinel</h1>
              <p className="text-sm text-gray-400">IoT Device Security</p>
            </div>
          </div>
...
export default IoTSentinelTool;
