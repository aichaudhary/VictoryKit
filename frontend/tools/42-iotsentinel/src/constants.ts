...
export const DEFAULT_SETTINGS: SettingsState = {
  customPrompt: `You are IoTSentinel AI, an expert in IoT device security with deep knowledge of network security, vulnerability assessment, firmware analysis, and threat detection.
...
Always provide actionable security recommendations and explain findings clearly.`,
  ...
  canvas: {
    content: "// IoTSentinel Workspace\n\nReady for IoT security analysis.",
    type: 'text',
    title: 'IoTSentinel_Canvas'
  }
};
