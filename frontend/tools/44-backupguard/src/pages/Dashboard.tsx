...
import { backupGuardAPI } from '../services/api';
  ...
  const loadDashboardData = async () => {
    try {
      const [statsData, jobsData, storageData] = await Promise.all([
        backupGuardAPI.dashboard.getStats(),
        backupGuardAPI.jobs.list({ limit: 10, sortBy: 'lastRun.startTime', sortOrder: 'desc' }),
        backupGuardAPI.storage.list()
      ]);
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-backupguard-primary"></div>
      </div>
    );
  }
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* Total Capacity */}
        <div className="bg-gradient-to-br from-backupguard-dark to-backupguard-darker p-6 rounded-2xl border border-backupguard-primary/20 hover:border-backupguard-primary/40 transition-all">
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-backupguard-darker h-2 rounded-full overflow-hidden">
              <div
        ...
        {/* Active Jobs */}
        <div className="bg-gradient-to-br from-backupguard-dark to-backupguard-darker p-6 rounded-2xl border border-backupguard-secondary/20 hover:border-backupguard-secondary/40 transition-all">
          <div className="flex items-center justify-between mb-4">
            <div className="w-12 h-12 bg-gradient-to-br from-backupguard-secondary to-backupguard-primary rounded-xl flex items-center justify-center glow-cyan">
        ...
        {/* Ransomware Blocked */}
        <div className="bg-gradient-to-br from-backupguard-dark to-backupguard-darker p-6 rounded-2xl border border-green-500/20 hover:border-green-500/40 transition-all">
          <div className="flex items-center justify-between mb-4">
        ...
        {/* Compliance Score */}
        <div className="bg-gradient-to-br from-backupguard-dark to-backupguard-darker p-6 rounded-2xl border border-backupguard-accent/20 hover:border-backupguard-accent/40 transition-all">
          <div className="flex items-center justify-between mb-4">
            <div className="w-12 h-12 bg-gradient-to-br from-backupguard-accent to-purple-600 rounded-xl flex items-center justify-center shadow-lg shadow-backupguard-accent/20">
          ...
          <div className="space-y-2">
            ...
            <div className="w-full bg-backupguard-darker h-2 rounded-full overflow-hidden">
              <div
                className="h-full bg-gradient-to-r from-backupguard-accent to-purple-600 transition-all duration-500"
      ...
      {/* Recent Backup Jobs */}
      <div className="bg-gradient-to-br from-backupguard-dark to-backupguard-darker p-6 rounded-2xl border border-backupguard-primary/20">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-white">Recent Backup Jobs</h2>
          <a href="/jobs" className="text-sm text-backupguard-primary hover:text-backupguard-secondary flex items-center">
            View all
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead>
              <tr className="text-left text-sm text-gray-400 border-b border-backupguard-primary/10">
            ...
            <tbody>
              {recentJobs.map((job) => (
                <tr key={job._id} className="border-b border-backupguard-primary/5 hover:bg-backupguard-primary/5 transition-colors">
                  <td className="py-4">
                    <div className="flex items-center space-x-3">
                      <Database className="w-5 h-5 text-backupguard-primary" />
                      <span className="font-medium text-white">{job.name}</span>
                    </div>
                  </td>
                  <td className="py-4">
                    <span className="px-3 py-1 bg-backupguard-primary/10 text-backupguard-primary rounded-full text-xs font-medium">
                      {job.type}
                    </span>
                  </td>
        ...
        <div className="bg-gradient-to-br from-backupguard-dark to-backupguard-darker p-6 rounded-2xl border border-backupguard-primary/20">
          ...
          <div className="space-y-4">
            {storagePools.slice(0, 5).map((pool) => (
              <div key={pool._id} className="p-4 bg-backupguard-darker rounded-xl border border-backupguard-primary/10 hover:border-backupguard-primary/30 transition-all">
                <div className="flex items-center justify-between mb-3">
                  <div className="flex items-center space-x-3">
                    <HardDrive className="w-5 h-5 text-backupguard-primary" />
                    <div>
        ...
        <div className="bg-gradient-to-br from-backupguard-dark to-backupguard-darker p-6 rounded-2xl border border-backupguard-primary/20">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="w-full bg-backupguard-darker h-3 rounded-full overflow-hidden">
                <div
            ...
            {/* Quick Actions */}
            <div className="mt-6 pt-6 border-t border-backupguard-primary/10">
              <h3 className="text-sm font-medium text-gray-400 mb-3">Quick Actions</h3>
              <div className="grid grid-cols-2 gap-3">
                <button className="px-4 py-3 bg-backup-gradient text-white rounded-xl font-medium hover:shadow-lg hover:shadow-backupguard-primary/20 transition-all flex items-center justify-center space-x-2">
                  <Calendar className="w-4 h-4" />
                  <span>New Job</span>
                </button>
                <button className="px-4 py-3 bg-backupguard-primary/10 text-backupguard-primary border border-backupguard-primary/20 rounded-xl font-medium hover:bg-backupguard-primary/20 transition-all flex items-center justify-center space-x-2">
