/**
 * SecretVault API Client
 * Tool 14 - Key Management & Data Encryption
 */

const API_BASE_URL = import.meta.env.VITE_SECRETVAULT_API_URL || 'http://localhost:4014/api/v1/encryption';
...
export const encryptionManagerApi = new SecretVaultApi();
