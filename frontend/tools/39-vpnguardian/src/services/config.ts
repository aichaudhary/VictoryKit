/**
 * VPNGuardian Configuration
 * Centralized configuration for the VPN security management tool
 */

import vpnguardianConfig from '../../vpnguardian-config.json';

export interface VPNGuardianConfig {
  toolInfo: {
    id: number;
    name: string;
    displayName: string;
...
export const config: VPNGuardianConfig = vpnguardianConfig as VPNGuardianConfig;
...
export const isFeatureEnabled = (featureGroup: keyof VPNGuardianConfig['features'], feature?: string): boolean => {
