/**
 * BrowserIsolation Configuration Service
 * Manages tool configuration and settings
 */

import configData from '../../browserisolation-config.json';
...
class ConfigService {
  private config: BrowserIsolationConfig;

  constructor() {
    this.config = configData as BrowserIsolationConfig;
  }

  // Get full configuration
  getConfig(): BrowserIsolationConfig {
    return this.config;
  }
