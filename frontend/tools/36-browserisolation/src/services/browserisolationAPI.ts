/**
 * BrowserIsolation API Client
 * TypeScript client for BrowserIsolation REST API
 */
...
export const browserisolationAPI = new BrowserIsolationAPI();
export default browserisolationAPI;
