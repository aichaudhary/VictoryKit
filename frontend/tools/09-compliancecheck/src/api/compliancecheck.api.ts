/**
 * ComplianceCheck API Client
 * Tool 09 - Regulatory Compliance Auditing & Framework Assessment
 * 
 * TypeScript client for communicating with ComplianceCheck backend
 */

const API_BASE_URL = import.meta.env.VITE_COMPLIANCECHECK_API_URL || 'http://localhost:4009/api';
...
export const complianceCheckApi = new ComplianceCheckApi();

// Export class for testing/custom instances
export { ComplianceCheckApi };
