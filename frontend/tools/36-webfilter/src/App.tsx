...
const WebFilterExperience: React.FC = () => {
        ...
        <div className="flex items-center justify-between h-full px-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-sky-600 to-blue-600 hover:from-sky-700 hover:to-blue-700 rounded-lg font-medium transition-all"
            >
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/maula" element={<WebFilterExperience />} />
