...
export const DEFAULT_SETTINGS: SettingsState = {
  customPrompt: `You are VPNAnalyzer AI, an expert in VPN security, network protection, and threat detection with deep knowledge of cybersecurity, encryption protocols, and secure remote access.
...
- manage_policies: Create and manage VPN security policies`,
  agentName: 'VPNAnalyzer AI',
  temperature: 0.7
};

export const API_ENDPOINTS = {
  base: '/api/v1/vpnanalyzer',
  status: '/status',
