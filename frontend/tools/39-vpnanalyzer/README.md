...
[![Version](https://img.shields.io/badge/version-1.0.0-cyan.svg)](https://vpnanalyzer.maula.ai)
...
```bash
# Clone and navigate
cd backend/tools/39-vpnanalyzer
...
# Backend
PORT=4039
MONGODB_URI=mongodb://localhost:27017/vpnanalyzer_db
...
│   └── vpnanalyzer-config.json # Tool configuration
│
└── backend/
    ├── api/                    # REST API routes
    ├── ml-engine/              # ML models
...
```bash
# Frontend
cd frontend/tools/39-vpnanalyzer
npm run build
...
- **Production**: https://vpnanalyzer.maula.ai
- **AI Assistant**: https://vpnanalyzer.maula.ai/maula/ai
- **API Docs**: https://vpnanalyzer.maula.ai/api/docs
