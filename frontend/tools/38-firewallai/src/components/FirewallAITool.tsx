...
const FirewallAITool: React.FC = () => {
  const [isActive, setIsActive] = useState(true);
  const [stats, setStats] = useState<Stats>({ total: 22958, active: 30256 % 500, blocked: 26236 % 1000, pending: 15577 % 50 });
      ...
      <header className="border-b border-orange-500/20 bg-black/30 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <a href="https://maula.ai/#tool-38" className="p-2 hover:bg-white/10 rounded-lg transition-colors" title="Back to Maula.ai">
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-orange-400 to-orange-200 bg-clip-text text-transparent">Firewall AI</h1>
              <p className="text-sm text-gray-400">Next-Gen Firewall Management</p>
            </div>
          </div>
