# IdentityForge Frontend

## Overview

IdentityForge is a modern, AI-powered web application for comprehensive access management and authorization. Built with React, TypeScript, and Tailwind CSS, it provides an intuitive interface for managing roles, permissions, policies, and security controls.
...
│   ├── IdentityForgeTool.tsx    # Main application component
│   └── NeuralLinkInterface.tsx  # AI assistant interface
├── api/                  # API client and types
│   └── identityforge.api.ts     # API functions and types
...
- Node.js 18+
- npm or yarn
- IdentityForge backend API running on port 4013

### Installation

1. **Navigate to the frontend directory:**
   ```bash
   cd frontend/tools/13-identityforge
   ```
...
|----------|-------------|---------|
| `VITE_ACCESSCONTROL_API_URL` | Backend API URL | `http://localhost:4013/api/v1/identityforge` |
| `VITE_APP_DOMAIN` | Application domain | `https://identityforge.maula.ai` |
| `VITE_NEURAL_LINK_URL` | Neural link URL | `https://identityforge.maula.ai/maula/ai` |
