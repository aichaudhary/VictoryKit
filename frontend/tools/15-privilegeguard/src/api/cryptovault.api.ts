/**
 * PrivilegeGuard API Client - Tool 15 - Secure Secrets Management
 */
const API_BASE_URL = import.meta.env.VITE_PRIVILEGEGUARD_API_URL || 'http://localhost:4015/api/v1';
...
export const cryptoVaultApi = new PrivilegeGuardApi();
