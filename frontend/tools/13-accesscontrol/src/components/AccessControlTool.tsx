...
export default function AccessControlTool() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-900 to-blue-950 text-white">
      ...
      <footer className="border-t border-gray-800 py-4 mt-12"><div className="max-w-7xl mx-auto px-4 text-center text-gray-500 text-sm">AccessControl Tool 13 • VictoryKit Security Platform</div></footer>
    </div>
  );
}
