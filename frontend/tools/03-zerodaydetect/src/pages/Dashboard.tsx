...
import { zeroDayDetectAPI } from '../services/api';
  ...
  const loadDashboardData = async () => {
    try {
      const [statsData, threatsData, vectorsData] = await Promise.all([
        zeroDayDetectAPI.dashboard.getStats(),
        zeroDayDetectAPI.threats.list({ limit: 5, status: 'active' }),
        zeroDayDetectAPI.intelligence.getAttackVectors()
      ]);
    ...
    return (
      <div className="flex items-center justify-center h-screen">
        <div className="relative">
          <Radar className="w-16 h-16 text-zerodaydetect-primary animate-radar-sweep" />
          <div className="absolute inset-0 rounded-full border-2 border-zerodaydetect-primary/30 animate-ping"></div>
        </div>
      </div>
    );
  }
    ...
    <div className="p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          <button className="px-4 py-2 bg-threat-gradient text-white rounded-lg font-medium hover:shadow-lg hover:shadow-zerodaydetect-primary/30 transition-all flex items-center space-x-2 animate-pulse-glow">
      ...
      {/* Threat Score Banner */}
      <div className="bg-gradient-to-r from-zerodaydetect-dark to-zerodaydetect-darker p-6 rounded-2xl border border-zerodaydetect-primary/20 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-zerodaydetect-primary/5 rounded-full blur-3xl"></div>
        <div className="relative flex items-center justify-between">
          ...
          <div className="w-48 h-48 relative">
            <div className="absolute inset-0 border-4 border-zerodaydetect-primary/20 rounded-full"></div>
            <div className="absolute inset-4 border-4 border-zerodaydetect-primary/30 rounded-full"></div>
            <div className="absolute inset-8 border-4 border-zerodaydetect-primary/40 rounded-full flex items-center justify-center">
              <Radar className="w-12 h-12 text-zerodaydetect-primary animate-radar-sweep" />
            </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {/* Active Threats */}
        <div className="bg-gradient-to-br from-zerodaydetect-dark to-zerodaydetect-darker p-6 rounded-2xl border border-red-500/20 hover:border-red-500/40 transition-all group">
        ...
        {/* Threats Blocked */}
        <div className="bg-gradient-to-br from-zerodaydetect-dark to-zerodaydetect-darker p-6 rounded-2xl border border-green-500/20 hover:border-green-500/40 transition-all">
          <div className="flex items-center justify-between mb-4">
        ...
        {/* Attack Surface */}
        <div className="bg-gradient-to-br from-zerodaydetect-dark to-zerodaydetect-darker p-6 rounded-2xl border border-blue-500/20 hover:border-blue-500/40 transition-all">
          <div className="flex items-center justify-between mb-4">
        ...
        {/* Threat Intelligence */}
        <div className="bg-gradient-to-br from-zerodaydetect-dark to-zerodaydetect-darker p-6 rounded-2xl border border-purple-500/20 hover:border-purple-500/40 transition-all">
          <div className="flex items-center justify-between mb-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Active Threats List */}
        <div className="bg-gradient-to-br from-zerodaydetect-dark to-zerodaydetect-darker p-6 rounded-2xl border border-zerodaydetect-primary/20">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-xl font-bold text-white">Active Threats</h2>
            <a href="/threats" className="text-sm text-zerodaydetect-primary hover:text-zerodaydetect-accent flex items-center">
              View all
          ...
          <div className="space-y-4">
            {threats.map((threat) => (
              <div key={threat._id} className="p-4 bg-zerodaydetect-darker rounded-xl border border-zerodaydetect-primary/10 hover:border-zerodaydetect-primary/30 transition-all group">
                <div className="flex items-center justify-between mb-2">
                  <div className="flex items-center space-x-3">
                    <span className={`w-3 h-3 rounded-full ${getSeverityBadge(threat.severity)} animate-pulse`}></span>
                    <h3 className="font-medium text-white group-hover:text-zerodaydetect-accent transition-colors">{threat.name}</h3>
                  </div>
          ...
          <div className="space-y-4">
            {attackVectors.map((vector, index) => (
              <div key={index} className="space-y-2">
                ...
                <div className="w-full bg-zerodaydetect-darker h-2 rounded-full overflow-hidden">
                  <div
      ...
      <div className="bg-gradient-to-br from-zerodaydetect-dark to-zerodaydetect-darker p-6 rounded-2xl border border-zerodaydetect-primary/20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <button className="p-4 bg-threat-gradient text-white rounded-xl font-medium hover:shadow-lg hover:shadow-zerodaydetect-primary/30 transition-all flex flex-col items-center space-y-2">
            <Radar className="w-6 h-6" />
            <span>Run Scan</span>
          </button>
          <button className="p-4 bg-zerodaydetect-primary/10 text-zerodaydetect-primary border border-zerodaydetect-primary/20 rounded-xl font-medium hover:bg-zerodaydetect-primary/20 transition-all flex flex-col items-center space-y-2">
