/**
 * XDRPlatform API Client
 * Tool 12 - AI-Powered Log Analysis & SIEM Integration
 */

const API_BASE_URL = import.meta.env.VITE_XDRPLATFORM_API_URL || 'http://localhost:4012/api/v1/xdrplatform';
...
export const logAnalyzerApi = new XDRPlatformApi();
