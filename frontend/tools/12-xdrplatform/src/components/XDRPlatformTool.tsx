      ...
      <header className="relative z-10 border-b border-purple-500/20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            >
              <span>←</span>
              <span className="text-sm tracking-widest">BACK TO ECOSYSTEM</span>
            </button>
          </div>
          ...
          <div className="flex items-center gap-4">
            <a 
              href="https://maula.ai"
              className="px-4 py-2 bg-purple-600/80 hover:bg-purple-600 text-white rounded-lg text-sm font-medium transition-all border border-purple-500/50"
            >
              ← BACK TO MAULA.AI
            </a>
            {usingSimulated && (
