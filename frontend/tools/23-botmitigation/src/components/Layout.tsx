...
export default function Layout() {
  ...
  const currentPage = navigation.find((item) => location.pathname.startsWith(resolvePath(item.href)))?.name || 'BotMitigation';
    ...
    <div className="min-h-screen bg-slate-900">
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-slate-800 border-b border-slate-700 px-4 py-3 flex items-center justify-between">
        <div className="flex items-center space-x-3">
          ...
          <span className="text-xl font-bold text-white">BotMitigation</span>
        </div>
          ...
          >
            <div className="p-6 border-b border-slate-700">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-xl font-bold text-white">BotMitigation</h1>
      ...
      <main className="lg:ml-64 min-h-screen pt-16 lg:pt-0">
        <div className="p-6 space-y-6">
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <p className="text-sm text-slate-400">BotMitigation</p>
