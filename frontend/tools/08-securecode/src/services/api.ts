...
export const analytics = {
  getOverview: (): Promise<AxiosResponse<any>> =>
    apiClient.get('/securecode/analytics/overview'),
  
  getLanguageBreakdown: (): Promise<AxiosResponse<any>> =>
    apiClient.get('/securecode/analytics/languages'),
  
  getVulnerabilityTypes: (): Promise<AxiosResponse<any>> =>
    apiClient.get('/securecode/analytics/vulnerability-types'),
};
