...
export default function Layout() {
  ...
  const currentPage = navigation.find(item => location.pathname.startsWith(buildPath(item.href)))?.name || 'APIShield';
            ...
            >
              <div className="flex items-center justify-between h-16 px-4 border-b border-api-border">
                <div className="flex items-center gap-3">
                  ...
                  <span className="font-bold text-white">APIShield</span>
                </div>
                <button
                  onClick={() => setMobileMenuOpen(false)}
