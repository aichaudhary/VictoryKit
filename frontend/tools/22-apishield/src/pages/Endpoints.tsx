...
export default function Endpoints() {
  ...
  const avgSecurityDashboard = Math.round(endpoints.reduce((sum, ep) => sum + (ep.securityScore ?? 0), 0) / endpoints.length);
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="api-card p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold text-white">{avgSecurityDashboard}%</p>
