...
export default function Dashboard() {
  const { realTimeEvents, liveMode } = useAPIShieldStore();
  ...
  const getSecurityDashboardColor = (score: number): string => {
        ...
        >
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className={clsx('text-3xl font-bold mt-1', getSecurityDashboardColor(dashboardStats.avgSecurityDashboard))}>
                {dashboardStats.avgSecurityDashboard}%
              </p>
              <div className="flex items-center gap-2 mt-2">
                <TrendingUp className="w-4 h-4 text-green-400" />
