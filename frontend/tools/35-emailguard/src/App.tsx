...
const EmailGuardExperience: React.FC = () => {
        ...
        <div className="flex items-center justify-between h-full px-4">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-rose-600 to-pink-600 hover:from-rose-700 hover:to-pink-700 rounded-lg font-medium transition-all"
            >
...
function App() {
  return (
    <Routes>
      ...
      <Route path="/maula" element={<EmailGuardExperience />} />
