...
import { phishNetAIAPI } from '../services/api';
  ...
  const loadDashboardData = async () => {
    try {
      const [statsData, detectionsData, campaignsData] = await Promise.all([
        phishNetAIAPI.dashboard.getStats(),
        phishNetAIAPI.detections.list({ limit: 5, status: 'detected' }),
        phishNetAIAPI.analytics.getCampaigns()
      ]);
  ...
  return (
    <div className="p-8 space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-white mb-2">PhishNetAI</h1>
