/**
 * AuditTrailProPro API Client - Tool 17 - Compliance Audit Logging
 * Enhanced with real-time, search, reports, and integrity features
 */
const API_BASE_URL = import.meta.env.VITE_AUDITTRAILPRO_API_URL || 'http://localhost:4017/api/v1/audittrailpropro';
...
export const auditTrailApi = new AuditTrailProProApi();
