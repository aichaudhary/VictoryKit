import { DNSQuery, BlockedDomain, ThreatIntelligence, DNSPolicy, DNSAnalytics, DomainReputation, DNSTunnelingLog, ResolverCache, DNSSECRecord, UserSettings, DNSStats, QueryPattern, ThreatReport } from '../types/dnsshield';
...
export default new DNSShieldAPI();
