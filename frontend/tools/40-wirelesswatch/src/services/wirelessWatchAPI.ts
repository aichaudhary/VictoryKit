// WirelessWatch API Service - Enterprise Wireless Network Security Monitoring
...
export const wirelessWatchAPI = new WirelessWatchAPI();
export default wirelessWatchAPI;
