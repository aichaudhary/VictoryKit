/**
 * WirelessWatch Configuration
 * Centralized configuration for wireless network security monitoring
 */

import wirelesswatchConfig from '../../wirelesswatch-config.json';

export interface WirelessWatchConfig {
  toolInfo: {
    id: number;
    name: string;
    displayName: string;
...
export const config: WirelessWatchConfig = wirelesswatchConfig as WirelessWatchConfig;
...
export const isFeatureEnabled = (featureGroup: keyof WirelessWatchConfig['features'], feature?: string): boolean => {
