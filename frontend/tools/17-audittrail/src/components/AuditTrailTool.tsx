  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-900 to-pink-950 text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div><h1 className="text-xl font-bold">AuditTrail</h1><p className="text-gray-400 text-sm">Compliance Audit Logging</p></div>
            </div>
            <div className="flex items-center gap-3">
      ...
      <footer className="border-t border-gray-800 py-4 mt-12">
        <div className="max-w-7xl mx-auto px-4 text-center text-gray-500 text-sm">AuditTrail Tool 17 • VictoryKit Security Platform • Real-time Compliance Monitoring</div>
      </footer>
    </div>
  );
}
