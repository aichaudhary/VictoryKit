...
const SIEMCommanderTool: React.FC = () => {
  const [isActive, setIsActive] = useState(true);
  const [stats, setStats] = useState<Stats>({ total: 31921, active: 28873 % 500, blocked: 11317 % 1000, pending: 7402 % 50 });
      ...
      <header className="border-b border-indigo-500/20 bg-black/30 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <a href="https://maula.ai/#tool-27" className="p-2 hover:bg-white/10 rounded-lg transition-colors" title="Back to Maula.ai">
            ...
            <div>
              <h1 className="text-2xl font-bold bg-gradient-to-r from-indigo-400 to-indigo-200 bg-clip-text text-transparent">SIEM Commander</h1>
              <p className="text-sm text-gray-400">Security Event Management</p>
            </div>
          </div>
...
export default SIEMCommanderTool;
