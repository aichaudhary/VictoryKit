...
const TOOL_PRICE = 1.0; // $1 USD
const ACCESS_DURATION = 24 * 60 * 60 * 1000; // 24 hours in milliseconds

const TOOLS = {
  fraudguard: 'FraudGuard - AI Fraud Detection',
  darkwebmonitor: 'DarkWebMonitor - OSINT Intelligence',
  zerodaydetect: 'ZeroDayDetect - Threat Detection',
  ransomshield: 'RansomShield - Malware Analysis',
  phishnetai: 'PhishNetAI - Phishing Detection',
  vulnscan: 'VulnScan - Vulnerability Scanning',
  pentestai: 'PenTestAI - Penetration Testing',
  codesentinel: 'CodeSentinel - Code Security',
  runtimeguard: 'RuntimeGuard - Compliance Auditing',
  dataguardian: 'DataGuardian - Data Protection',
  cryptoshield: 'CryptoShield - Cryptography',
  xdrplatform: 'xdrplatform - IAM Management',
  ...
  apishieldian: 'APIGuardian - API Security',
  ...
  supplychainaiian: 'SupplyChainAIian - Backup Security',
