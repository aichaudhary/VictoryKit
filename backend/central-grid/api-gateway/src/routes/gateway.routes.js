...
const tools = [
  ...
  { name: 'darkwebmonitor', port: 4002 },
  { name: 'zerodaydetect', port: 4003 },
  { name: 'ransomshield', port: 4004 },
  { name: 'phishnetai', port: 4005 },
  { name: 'vulnscan', port: 4006 },
  { name: 'pentestai', port: 4007 },
  { name: 'codesentinel', port: 4008 },
  ...
  { name: 'supplychainaiian', port: 4030 },
