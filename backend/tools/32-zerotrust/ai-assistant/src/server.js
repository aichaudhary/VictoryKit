...
wss.on('connection', (ws) => {
  console.log('🔗 New Zero Trust AI connection');
  
  ws.send(JSON.stringify({
    type: 'connection',
    message: 'Connected to ZeroTrust Assistant',
  ...
  ws.on('close', () => {
    console.log('🔌 Zero Trust AI connection closed');
  });
});

server.listen(PORT, () => {
  console.log(`🤖 ZeroTrust Assistant running on port ${PORT} at /maula/ai`);
});
