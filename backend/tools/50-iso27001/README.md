...
- **Name:** iso27001_db
- **Type:** MongoDB
- **Connection:** mongodb://localhost:27017/iso27001_db
...
##### Programs
- `POST /api/v1/iso27001/programs` - Create program
- `GET /api/v1/iso27001/programs` - List programs
- `GET /api/v1/iso27001/programs/:id` - Get program details
- `PUT /api/v1/iso27001/programs/:id` - Update program
- `DELETE /api/v1/iso27001/programs/:id` - Delete program

##### Researchers
- `POST /api/v1/iso27001/researchers` - Register researcher
- `GET /api/v1/iso27001/researchers` - List researchers
- `GET /api/v1/iso27001/researchers/:id` - Get researcher profile
- `PUT /api/v1/iso27001/researchers/:id` - Update profile
- `GET /api/v1/iso27001/researchers/leaderboard` - Get leaderboard

##### Submissions
- `POST /api/v1/iso27001/submissions` - Submit vulnerability
- `GET /api/v1/iso27001/submissions` - List submissions
- `GET /api/v1/iso27001/submissions/:id` - Get submission details
- `PUT /api/v1/iso27001/submissions/:id` - Update submission
- `POST /api/v1/iso27001/submissions/:id/triage` - Triage submission
- `POST /api/v1/iso27001/submissions/:id/validate` - Validate vulnerability
- `GET /api/v1/iso27001/submissions/duplicates` - Check duplicates

##### Rewards
- `POST /api/v1/iso27001/rewards` - Create reward
- `GET /api/v1/iso27001/rewards` - List rewards
- `GET /api/v1/iso27001/rewards/:id` - Get reward details
- `PUT /api/v1/iso27001/rewards/:id` - Update reward
- `POST /api/v1/iso27001/rewards/:id/approve` - Approve payout
- `POST /api/v1/iso27001/rewards/:id/pay` - Process payment

### ✅ Frontend (Complete)
#### Configuration
- **package.json** - Updated to "iso27001", port 3050
- **vite.config.ts** - Configured ports 3050/4050/6050
- **index.html** - ISO27001 branding
- **iso27001-config.json** - Comprehensive configuration
...
Based on iso27001-config.json, the system includes:
...
### Backend
```bash
cd backend/tools/50-iso27001/api
npm install
...
### ML Engine
```bash
cd backend/tools/50-iso27001/ml-engine
