...
- **Domain**: `securitydashboard.maula.ai`
- **Frontend Port**: 3020
- **Backend Port**: 4020
- **ML Service Port**: 8020
- **Database**: `securitydashboard_db`
...
│       │   ├── SecurityDashboard.js      # Main security score entity
...
│           └── securitydashboard.routes.js
└── README.md                 # This file
```

## 📊 Data Models

### 1. SecurityDashboard Model (669 lines)
...
- **GET** `/api/securitydashboard/status` - Health check
- **GET** `/api/securitydashboard/dashboard` - Dashboard overview

### Security Score Management (8 endpoints)

- **POST** `/api/securitydashboard/scores` - Create security score
- **GET** `/api/securitydashboard/scores` - List scores with pagination
- **GET** `/api/securitydashboard/scores/top` - Get top performers
- **GET** `/api/securitydashboard/scores/:id` - Get score by ID
- **PUT** `/api/securitydashboard/scores/:id` - Update score
- **DELETE** `/api/securitydashboard/scores/:id` - Delete score
- **POST** `/api/securitydashboard/scores/:id/calculate` - Recalculate score
- **GET** `/api/securitydashboard/scores/:id/history` - Get score history

### Metric Management (6 endpoints)

- **POST** `/api/securitydashboard/metrics` - Create metric
- **GET** `/api/securitydashboard/metrics` - List metrics
- **GET** `/api/securitydashboard/metrics/critical` - Get critical metrics
- **GET** `/api/securitydashboard/metrics/category/:category` - Get by category
- **GET** `/api/securitydashboard/metrics/:id` - Get metric by ID
- **PATCH** `/api/securitydashboard/metrics/:id/value` - Update metric value

### Assessment Management (6 endpoints)

- **POST** `/api/securitydashboard/assessments` - Create assessment
- **GET** `/api/securitydashboard/assessments` - List assessments
- **GET** `/api/securitydashboard/assessments/recent` - Get recent
- **GET** `/api/securitydashboard/assessments/:id` - Get by ID
- **PUT** `/api/securitydashboard/assessments/:id` - Update assessment
- **POST** `/api/securitydashboard/assessments/:id/complete` - Complete assessment

### Benchmark Management (4 endpoints)

- **POST** `/api/securitydashboard/benchmarks` - Create benchmark
- **GET** `/api/securitydashboard/benchmarks` - List benchmarks
- **GET** `/api/securitydashboard/benchmarks/:id` - Get by ID
- **GET** `/api/securitydashboard/benchmarks/:benchmarkId/compare/:scoreId` - Compare

### Improvement Management (5 endpoints)

- **POST** `/api/securitydashboard/improvements` - Create improvement
- **GET** `/api/securitydashboard/improvements` - List improvements
- **GET** `/api/securitydashboard/improvements/:id` - Get by ID
- **PATCH** `/api/securitydashboard/improvements/:id/progress` - Update progress
- **POST** `/api/securitydashboard/improvements/:id/approve` - Approve

### Control Management (5 endpoints)

- **POST** `/api/securitydashboard/controls` - Create control
- **GET** `/api/securitydashboard/controls` - List controls
- **GET** `/api/securitydashboard/controls/:id` - Get by ID
- **PATCH** `/api/securitydashboard/controls/:id/implementation` - Update implementation
- **POST** `/api/securitydashboard/controls/:id/test` - Record test

### Framework Management (4 endpoints)

- **POST** `/api/securitydashboard/frameworks` - Create framework
- **GET** `/api/securitydashboard/frameworks` - List frameworks
- **GET** `/api/securitydashboard/frameworks/:id` - Get by ID
- **POST** `/api/securitydashboard/frameworks/:id/compliance` - Update compliance

### Report Management (4 endpoints)

- **POST** `/api/securitydashboard/reports` - Generate report
- **GET** `/api/securitydashboard/reports` - List reports
- **GET** `/api/securitydashboard/reports/:id` - Get by ID
- **POST** `/api/securitydashboard/reports/:id/distribute` - Distribute
...
1. **Navigate to tool directory**:
   ```bash
   cd backend/tools/20-securitydashboard/api
   ```
...
3. **Configure environment variables**:
   ```env
   PORT=4020
   MONGODB_URI=mongodb://localhost:27017/securitydashboard_db
...
5. **Verify installation**:
   ```bash
   curl http://localhost:4020/api/securitydashboard/status
   ```
...
```env
PORT=4020
MONGODB_URI=mongodb://mongodb:27017/securitydashboard_db
NODE_ENV=production
API_PREFIX=/api/securitydashboard
RATE_LIMIT_WINDOW_MS=900000
RATE_LIMIT_MAX_REQUESTS=100
LOG_LEVEL=info
JWT_SECRET=your-secret-key
CORS_ORIGIN=https://securitydashboard.maula.ai
```
...
SecurityDashboard integrates with:
- **VulnScan (Tool #6)**: Import vulnerability data
- **ZeroDayDetect (Tool #3)**: Incorporate threat intelligence
- **DarkWebMonitor (Tool #2)**: Use intelligence for risk assessment
- **PhishNetAI (Tool #5)**: Include phishing metrics
...
- **API Documentation**: `/api/securitydashboard/docs`
