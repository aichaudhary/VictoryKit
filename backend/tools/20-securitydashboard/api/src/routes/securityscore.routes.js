...
/**
 * SecurityDashboard Tool - RESTful Routes
...
router.post('/scores', controller.createSecurityDashboard);
router.get('/scores', controller.getSecurityDashboards);
router.get('/scores/top', controller.getTopPerformers);
router.get('/scores/:id', controller.getSecurityDashboardById);
router.put('/scores/:id', controller.updateSecurityDashboard);
router.delete('/scores/:id', controller.deleteSecurityDashboard);
