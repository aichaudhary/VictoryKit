# 📊 LogAnalyzer - AI-Powered Log Intelligence Platform

<div align="center">

![LogAnalyzer Logo](https://img.shields.io/badge/LogAnalyzer-AI%20Log%20Intelligence-06b6d4?style=for-the-badge&logo=file-text&logoColor=white)
...
[Live Demo](https://loganalyzer.maula.ai) • [API Docs](https://loganalyzer.maula.ai/docs) • [Report Bug](https://github.com/VM07B/VictoryKit/issues)
...
**LogAnalyzer** is a cutting-edge, AI-powered log management platform designed to aggregate, parse, search, and analyze logs from any source at massive scale. Leveraging advanced machine learning for intelligent pattern detection, anomaly identification, and predictive analytics, LogAnalyzer transforms your log data into actionable insights.
...
cd backend/tools/12-loganalyzer/api
npm install
...
cd ../../../../frontend/tools/12-loganalyzer
npm install
...
services:
  ...
  loganalyzer-frontend:
    build: ../../../frontend/tools/12-loganalyzer
    ports:
      - "3012:3012"
...
MONGODB_URI=mongodb://localhost:27017/loganalyzer
...
KAFKA_CONSUMER_GROUP=loganalyzer
...
```
Production: https://loganalyzer.maula.ai/api/v1
...
```http
POST /api/v1/loganalyzer/search
...
```http
POST /api/v1/loganalyzer/sources
Authorization: Bearer {token}
Content-Type: application/json
```
...
```http
POST /api/v1/loganalyzer/alerts
Authorization: Bearer {token}
Content-Type: application/json
```
...
- **Documentation**: https://docs.loganalyzer.maula.ai
- **API Status**: https://status.loganalyzer.maula.ai
...
![LogAnalyzer](https://img.shields.io/badge/LogAnalyzer-AI%20Log%20Intelligence-06b6d4?style=for-the-badge)
