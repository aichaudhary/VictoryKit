...
app.get('/api-docs', (req, res) => {
  res.json({
    ...
    endpoints: {
      ...
      dnsAnalysis: '/api/v1/dnsshield/analyze',
      domainReputation: '/api/v1/dnsshield/domain/{domain}/reputation',
      statistics: '/api/v1/dnsshield/stats',
      policies: '/api/v1/dnsshield/policies',
      alerts: '/api/v1/dnsshield/alerts',
      reports: '/api/v1/dnsshield/reports'
    },
    websocket: {
...
// Main API routes
app.use('/api/v1/dnsshield', require('./routes/dnsShieldRoutes'));
