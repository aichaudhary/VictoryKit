...
├─────────────────────────────────────────────────────────────┤
│  Database: MongoDB                       DB: apiguard_db    │
...
cd backend/tools/22-apiguard

# Install dependencies
npm install

# Set environment variables
export MONGODB_URI=mongodb://localhost:27017/apiguard_db
...
services:
  apiguard:
    build: ./backend/tools/22-apiguard
    ports:
      - "4022:4022"
      - "6022:6022"
    environment:
      - MONGODB_URI=mongodb://mongo:27017/apiguard_db
