...
### Tool Configuration
- **Tool ID**: 31
- **Tool Name**: CloudPosture
- **Domain**: cloudposture.maula.ai
- **Frontend Port**: 3031
- **API Port**: 4031
- **ML Port**: 8031
- **AI Assistant Port**: 6031
- **Database**: cloudposture_db (MongoDB)
...
### Base URL
```
http://cloudposture.maula.ai:4031/api/v1/cloudposture
```
...
```
ws://cloudposture.maula.ai:6031/maula/ai
```
...
### Backend API
```bash
cd backend/tools/31-cloudposture/api
npm install
npm start
# Runs on port 4031
```
...
### AI Assistant
```bash
cd backend/tools/31-cloudposture/ai-assistant
npm install
npm start
# Runs on port 6031
```
...
### Frontend
```bash
cd frontend/tools/31-cloudposture
npm install
npm run dev
# Runs on port 3031
```
