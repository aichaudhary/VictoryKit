...
const API_BASE = process.env.API_BASE_URL || 'http://localhost:4031/api/v1/audittracker';
    ...
    try {
      ...
      switch (func.name) {
        ...
        case 'analyze_audit_trail':
          result = await analyzeAuditTrail(func.parameters);
          break;
...
async function analyzeAuditTrail(params) {
