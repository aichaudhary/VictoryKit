...
├─────────────────────────────────────────────────────────────────┤
│  MongoDB Database: cryptovault_db                                │
│  ├── Vaults Collection                                           │
│  ├── Keys Collection                                             │
...
CryptoVault serves organizations requiring robust cryptographic key management:
...
### Backend Setup
```bash
cd backend/tools/15-cryptovault/api
npm install
cp .env.example .env
...
### Frontend Setup
```bash
cd frontend/tools/15-cryptovault
npm install
npm run dev
```
...
### AI Assistant Setup
```bash
cd backend/tools/15-cryptovault/ai-assistant
npm install
npm run dev
```
...
### ML Service Setup
```bash
cd backend/tools/15-cryptovault/ml-engine
...
```env
# Database
MONGODB_URI=mongodb://localhost:27017/cryptovault_db
...
<parameter name="filePath">/workspaces/VictoryKit/backend/tools/15-cryptovault/README.md