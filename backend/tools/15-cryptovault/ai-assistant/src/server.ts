...
console.log(`🔐 CryptoVault AI Assistant started on port ${PORT}`);
...
wss.on('connection', (ws: WebSocket) => {
  ...
  const welcomeMessage: AIResponse = {
    id: uuidv4(),
    type: 'welcome',
    content: 'Welcome to CryptoVault AI Assistant. I can help you with vault design, key management, cryptographic operations, and security policies.',
    suggestions: [
...
// Graceful shutdown
process.on('SIGINT', () => {
  console.log('\n🛑 Shutting down CryptoVault AI Assistant...');
  wss.close(() => {
