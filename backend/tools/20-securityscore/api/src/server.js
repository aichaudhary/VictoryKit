/**
 * SecurityScore API Server - Enhanced v2.0
...
async function initializeServices() {
  console.log('Initializing SecurityScore services...');
...
// MongoDB Connection
// ======================
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/victorykit_securityscore';
