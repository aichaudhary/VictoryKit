...
**Production URL:** `https://ddosdefender.maula.ai`
...
│  └── Baseline Modeling                                           │
├─────────────────────────────────────────────────────────────────┤
│  MongoDB Database: ddosdefender_db                                 │
│  ├── Traffic                                                     │
│  ├── Attack                                                      │
│  ├── Protection                                                  │
│  └── Blocklist                                                   │
...
```bash
MONGODB_URI=mongodb://localhost:27017/ddosdefender_db
...
```bash
# Backend API
cd backend/tools/24-ddosdefender/api
npm install
npm run dev

# AI Assistant
cd backend/tools/24-ddosdefender/ai-assistant
npm install
npm run dev

# Frontend
cd frontend/tools/24-ddosdefender
npm install
npm start
```
