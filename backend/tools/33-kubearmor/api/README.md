...
```env
# Database
MONGODB_URI=mongodb://localhost:27017/kubearmor
...
### Docker
```bash
docker build -t kubearmor-api .
docker run -p 4000:4000 kubearmor-api
```
...
For support, email support@kubearmor.com or join our Slack community.
