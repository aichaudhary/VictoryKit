...
### Scanning
- `POST /api/v1/soc2automator/scans` - Start new scan
- `GET /api/v1/soc2automator/scans` - List all scans
- `GET /api/v1/soc2automator/scans/:scanId` - Get scan status

### Requirements
- `GET /api/v1/soc2automator/requirements` - List all requirements
- `GET /api/v1/soc2automator/requirements/:id` - Get requirement details
- `POST /api/v1/soc2automator/requirements/analyze` - Deep analysis

### Findings
- `GET /api/v1/soc2automator/findings` - List findings with filters
- `GET /api/v1/soc2automator/findings/:id` - Get finding details
- `PUT /api/v1/soc2automator/findings/:id` - Update finding

### Remediation
- `GET /api/v1/soc2automator/remediations` - List remediation tasks
- `POST /api/v1/soc2automator/remediations/plan` - Create remediation plan
- `PUT /api/v1/soc2automator/remediations/:id` - Update task

### Assets
- `GET /api/v1/soc2automator/assets` - List assets
- `POST /api/v1/soc2automator/assets/detect-chd` - Detect cardholder data

### Reports
- `GET /api/v1/soc2automator/reports` - List reports
- `POST /api/v1/soc2automator/reports/generate` - Generate new report
- `GET /api/v1/soc2automator/reports/:id` - Download report

### Dashboard
- `GET /api/v1/soc2automator/dashboard` - Get dashboard data
- `GET /api/v1/soc2automator/status` - System status
