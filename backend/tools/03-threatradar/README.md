# 🎯 ThreatRadar - Real-Time Threat Intelligence & Detection Platform

<div align="center">

![ThreatRadar Logo](https://img.shields.io/badge/ThreatRadar-Threat%20Intelligence-EF4444?style=for-the-badge&logo=radar&logoColor=white)
...
[Live Demo](https://threatradar.maula.ai) • [API Docs](https://threatradar.maula.ai/docs) • [Support](mailto:support@maula.ai)
...
**ThreatRadar** is an enterprise-grade threat intelligence and detection platform that provides real-time visibility into cyber threats targeting your organization. Using advanced ML algorithms and global threat feeds, ThreatRadar identifies, analyzes, and responds to threats before they impact your business.
...
```bash
# Clone repository
git clone https://github.com/maula-ai/threatradar.git
cd threatradar

# Install backend dependencies
cd backend/tools/03-threatradar/api
npm install
...
cd ../../../frontend/tools/03-threatradar
npm install
...
NODE_ENV=production
PORT=4003
MONGODB_URI=mongodb://localhost:27017/threatradar_db
...
### threatradar-config.json

```json
{
  "toolName": "ThreatRadar",
  "toolNumber": 3,
  "subdomain": "threatradar.maula.ai",
  "ports": {
    "frontend": 3003,
    "api": 4003,
    "ml": 8003,
...
```
Production: https://threatradar.maula.ai/api/v1
...
### Documentation
- [User Guide](https://docs.threatradar.maula.ai)
- [API Reference](https://api.threatradar.maula.ai/docs)
- [MITRE ATT&CK Mapping](https://threatradar.maula.ai/mitre)

### Community
- [Discord Community](https://discord.gg/threatradar)
- [GitHub Discussions](https://github.com/maula-ai/threatradar/discussions)
- [Threat Intel Sharing](https://stix.threatradar.maula.ai)

### Enterprise Support
- 24/7 Phone Support: +1 (888) THREAT-1
- Email: enterprise@threatradar.maula.ai
