...
class IncidentService {
  ...
  basicClassification(incident) {
    ...
    if (combined.includes('ransomware') || combined.includes('encrypt')) {
      ...
      category = 'Impact';
      techniques = ['T1486'];
    } else if (combined.includes('phishing') || combined.includes('credential')) {
      type = 'phishing';
      ...
      techniques = ['T1041'];
    } else if (combined.includes('ddos') || combined.includes('denial of service')) {
      type = 'ddos';
      category = 'Impact';
      techniques = ['T1498'];
      ...
      category = 'Initial Access';
      techniques = ['T1078'];
    } else if (combined.includes('apt') || combined.includes('advanced persistent')) {
      type = 'apt';
      category = 'Collection';
  ...
  async integrateWithSecurityStack(incidentId, incidentData) {
    try {
      ...
      console.log('incidentcommand security stack integration completed');
    } catch (error) {
      console.error('incidentcommand integration error:', error);
    }
  }
}
