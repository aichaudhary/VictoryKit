...
// ============= FORENSICS ROUTES =============
router.post('/forensics/incidents/:id/analyze', forensicsController.analyzeIncident);
router.post('/forensics/indicators', forensicsController.analyzeIndicators);
router.post('/forensics/evidence/:id/analyze', forensicsController.analyzeEvidence);
router.get('/forensics/mitre/:techniqueId', forensicsController.getMitreTechnique);
router.get('/forensics/playbooks/templates', forensicsController.getPlaybookTemplates);
