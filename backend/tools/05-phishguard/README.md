# 🎣 PhishGuard - AI-Powered Phishing Detection & Email Security

<div align="center">

![PhishGuard Logo](https://img.shields.io/badge/PhishGuard-Email%20Security%20AI-F97316?style=for-the-badge&logo=mail&logoColor=white)
...
[Live Demo](https://phishguard.maula.ai) • [API Docs](https://phishguard.maula.ai/docs) • [Report Bug](https://github.com/VM07B/VictoryKit/issues)
...
**PhishGuard** is a cutting-edge, AI-powered phishing detection and email security platform designed to protect organizations from sophisticated email-based threats. Leveraging advanced NLP, computer vision, and behavioral analysis, PhishGuard provides comprehensive protection against phishing, spear-phishing, BEC (Business Email Compromise), and credential harvesting attacks.
...
cd ../../../../frontend/tools/05-phishguard
npm install
...
services:
  phishguard-api:
    ...
    environment:
      - NODE_ENV=production
      - MONGODB_URI=mongodb://mongo:27017/phishguard
  ...
  phishguard-frontend:
    build: ../../../frontend/tools/05-phishguard
    ports:
      - "3005:3005"
...
SMTP_PORT=587
SMTP_USER=phishguard@example.com
...
```
Production: https://phishguard.maula.ai/api/v1
...
- **Documentation**: https://docs.phishguard.maula.ai
- **API Status**: https://status.phishguard.maula.ai
...
![PhishGuard](https://img.shields.io/badge/PhishGuard-Email%20Security%20AI-F97316?style=for-the-badge)
