# 🔌 IoTSentinel - Enterprise IoT Security & Device Management Platform

<div align="center">

![IoTSentinel Logo](https://img.shields.io/badge/IoTSentinel-IoT%20Security-06B6D4?style=for-the-badge&logo=wifi&logoColor=white)
...
[Live Demo](https://iotsentinel.maula.ai) • [API Docs](https://iotsentinel.maula.ai/docs) • [Support](mailto:support@maula.ai)
...
**IoTSentinel** is an enterprise-grade IoT security platform designed to protect organizations from the growing threats targeting connected devices, industrial control systems, and smart infrastructure.
...
```bash
# Clone repository
git clone https://github.com/maula-ai/iotsentinel.git
cd iotsentinel

# Install backend dependencies
cd backend/tools/42-iotsentinel/api
npm install
...
cd ../../../frontend/tools/42-iotsentinel
npm install
...
NODE_ENV=production
PORT=4042
MONGODB_URI=mongodb://localhost:27017/iotsentinel_db
...
### iotsentinel-config.json

```json
{
  "toolName": "IoTSentinel",
  "toolNumber": 42,
  "subdomain": "iotsentinel.maula.ai",
  "ports": {
    "frontend": 3042,
    "api": 4042,
    "ml": 8042,
...
```
Production: https://iotsentinel.maula.ai/api/v1
...
### Documentation
- [User Guide](https://docs.iotsentinel.maula.ai)
- [API Reference](https://api.iotsentinel.maula.ai/docs)
- [Video Tutorials](https://youtube.com/iotsentinel)

### Community
- [Discord Community](https://discord.gg/iotsentinel)
- [GitHub Discussions](https://github.com/maula-ai/iotsentinel/discussions)

### Enterprise Support
- 24/7 Phone Support: +1 (888) IOT-SEC-1
- Email: enterprise@iotsentinel.maula.ai
