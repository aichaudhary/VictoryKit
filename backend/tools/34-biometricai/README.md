...
│   └── package.json
│
└── frontend/                     # React Frontend (see /frontend/tools/34-biometricai)
    ├── src/
    │   └── services/
    │       ├── biometricAPI.ts   # REST API client
    │       ├── aiService.ts      # WebSocket AI client
    │       └── config.ts         # Configuration loader
    ├── biometricai-config.json   # Tool configuration
    ├── index.html
    ├── vite.config.ts
    ├── nginx.conf
    └── package.json
...
```bash
# Backend API
cd backend/tools/34-biometricai/api
npm install
npm run dev

# AI Assistant
cd backend/tools/34-biometricai/ai-assistant
npm install
npm run dev

# Frontend
cd frontend/tools/34-biometricai
npm install
npm run dev
```
...
# API Configuration
API_PORT=4034
MONGODB_URI=mongodb://localhost:27017/biometricai_db
...
For support, contact the BiometricAI team or open an issue in the repository.

---

**BiometricAI** - Secure Multi-Modal Biometric Authentication Platform
