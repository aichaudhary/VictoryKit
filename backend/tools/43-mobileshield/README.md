# Tool #43 - MobileShield: Enterprise Mobile Application Security Platform

## 📱 Overview

**MobileShield** is a comprehensive enterprise platform for securing iOS and Android mobile applications. It provides end-to-end security assessment through SAST/DAST scanning, runtime application self-protection (RASP), mobile threat defense (MTD), malware detection, and compliance reporting.
...
│  │  Services: MobileShield, Scanning, Threat Detection  │  │
...
```bash
# Frontend
cd frontend/tools/43-mobileshield
npm install
npm run dev  # Port 3043

# Backend API
cd backend/tools/43-mobileshield/api
npm install
npm run dev  # Port 4043

# ML Engine
cd backend/tools/43-mobileshield/ml-engine
...
version: '3.8'
services:
  mobileshield-frontend:
    build: ./frontend/tools/43-mobileshield
    ports:
      - "3043:3043"
    environment:
      - VITE_API_URL=http://mobileshield-api:4043
      - VITE_ML_URL=http://mobileshield-ml:8043
  
  mobileshield-api:
    build: ./backend/tools/43-mobileshield/api
    ports:
      - "4043:4043"
    environment:
      - MONGODB_URI=mongodb://mongo:27017/mobileshield_db
      - ML_ENGINE_URL=http://mobileshield-ml:8043
  
  mobileshield-ml:
    build: ./backend/tools/43-mobileshield/ml-engine
    ports:
      - "8043:8043"
...
```
PORT=4043
MONGODB_URI=mongodb://localhost:27017/mobileshield_db
ML_ENGINE_URL=http://localhost:8043
JWT_SECRET=your-secret-key
AWS_S3_BUCKET=mobileshield-binaries
```
...
frontend/tools/43-mobileshield/
├── src/
│   ├── pages/
│   ├── components/
│   ├── services/
...
- Documentation: `mobileshield.maula.ai/docs`
- AI Assistant: `mobileshield.maula.ai/maula/ai`
- Email: support@mobileshield.com
